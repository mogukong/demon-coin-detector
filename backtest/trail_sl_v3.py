    ...
    for i in range(72, len(klines)):
        ...
        if pos:
            ...
            if mode == "no_trail":
                ...
                if peak >= 0.10:
                    current_sl = -0.03; sl_moved = True
            elif mode == "trail_15_5":
                if peak >= 0.15:
                    current_sl = -0.05; sl_moved = True
            elif mode == "trail_20_5":
                if peak >= 0.20:
                    current_sl = -0.05; sl_moved = True
            elif mode == "trail_30_5":
                if peak >= 0.30:
                    current_sl = -0.05; sl_moved = True
            elif mode == "trail_30_8":
                if peak >= 0.30:
                    current_sl = -0.08; sl_moved = True
...
modes = [
    ...
    ("trail_20_5", "盈利20%→止损+5%"),
    ("trail_30_5", "盈利30%→止损+5%)"),
    ("trail_30_8", "盈利30%→止损+8%"),
]
